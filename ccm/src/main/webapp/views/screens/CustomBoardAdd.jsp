...
<form action="/CustomBoardAddHandler.do" id="add" name="add" method="post" enctype="multipart/form-data">
    <p>제목 <input type="text" size="30" id="cus_name" name="cus_name"  placeholder="제목을 입력하세요." class="add_name-title"></p>
    이미지: <input type="file" name="file" id="file" onchange="previewImage()" class="add_image_button"><br/>
    <img id="preview" src="#" alt="미리보기" style="max-width: 300px; max-height: 300px;" class="add_image_preview"><br>
    내용<p><textarea cols="50" rows="10" id="cus_content" name="cus_content" placeholder="내용을 입력하세요." class="add_content"></textarea></p>
